...
public class Base {
	...
	public WebElement getRelativeElementbelow(String xpath,String aboveXpath)
	{
		return driver.findElement(RelativeLocator.with(By.xpath(xpath)).above(By.xpath(aboveXpath)));	}
